...
"""PyInstaller recipe for a single windowed NANDTrack.exe.

Build with:  pyinstaller nandtrack.spec --noconfirm --clean
"""
...
# PySide6 ships a lot of Qt. Leaving these out takes the one-file build from
# roughly 180 MB down to about 60 MB without losing anything the app uses.
EXCLUDES = [
...
icon = "nandtrack.ico" if os.path.exists("nandtrack.ico") else None
